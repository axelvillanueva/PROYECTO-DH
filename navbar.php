   ...
   <nav  id="barraN" class="col-12 barra-busqueda navbar navbar-expand-lg navbar-dark p-0 ">
     ...
     <div class="collapse navbar-collapse" id="menu">
       ...
       <form class="form-inline justify-content-center">
         <a class="enlace-nav btn text-white p-2 ml-3" style="font-size: 22px; background-color: red; margin-right: 0.29rem!important"href="Registro.php">Registrarse</a>
         <a class="enlace-nav btn text-white p-2 mr-3" style="font-size: 22px; background-color: red;" href="Log-in.php">Ingresar</a>
       </form>
     </div>
   </nav>
 </body>
